package com.example.SpringBootPjF1;
...
public class DBSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        c1.setConstructors(List.of(d1, d2));
        c2.setConstructors(List.of(d3, d4));
        c3.setConstructors(List.of(d5, d6));
        c4.setConstructors(List.of(d7, d8));
        c5.setConstructors(List.of(d9, d10));
        c6.setConstructors(List.of(d11, d12));
        c7.setConstructors(List.of(d13, d14));
        c8.setConstructors(List.of(d15, d16));
        c9.setConstructors(List.of(d17, d18));
        c10.setConstructors(List.of(d19, d20));

        constructorRepository.saveAll(List.of(c1, c2, c3, c4, c5, c6, c7, c8, c9, c10));
